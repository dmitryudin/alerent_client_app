...
class MyScreen extends State<LoginScreen>{
  ...
  Widget build(BuildContext context) {
    ...
    return(Scaffold(
      appBar: AppBar(
        title: Text('Alerent - Авторизация'),
      ),
        body: Form(
            key: _formKey,
            child: Center(
            child: ListView(
                padding: EdgeInsets.symmetric(vertical: height*0.09, horizontal: width*0.01),
                children: <Widget>[
                    Image.asset(
                ...
                Container(
                  ...
                  TextButton(
                    ...
                    ,),
                  TextButton(
                    child: Text("Зарегестрироваться", style: Theme.of(context).textTheme.headline2),
                    onPressed: () {
